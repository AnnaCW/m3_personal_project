class ListeningSession extends React.Component {
  ...
  render() {
    ...
    return(
      <tr className='session-box' id={this.props.listeningSession.id}>
      ...
      <td>
        <label>Notes</label>
        <textArea className='form-control notesTextarea' id={this.props.listeningSession.id} rows='5'>{this.props.listeningSession.notes}</textArea>
       </td>
      ...
      <td>
        ...
        <td>
          <label>Awareness of Surroundings Before</label>
            <select className="form-control-inline awareness-before" id={this.props.listeningSession.id} selected={this.props.listeningSession.awareness_before}>
